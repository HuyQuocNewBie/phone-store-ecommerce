...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const result = await login(form.TaiKhoan, form.MatKhau);
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-sky-500 to-violet-600 rounded-2xl mx-auto mb-4 flex items-center justify-center shadow-lg shadow-sky-500/25">
            <LayoutDashboard className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-slate-100">Admin Dashboard</h1>
          <p className="text-slate-400 text-sm mt-1">Phone Store E-Commerce</p>
        </div>
        ...
        >
          ...
          <div className="space-y-5 mt-4">
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1.5">Tài khoản</label>
              <input
                id="input-taikhoan"
                type="text"
                value={form.TaiKhoan}
                ...
                className="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition"
                required
              />
            </div>
            <div>
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-gradient-to-r from-sky-500 to-violet-600 hover:from-sky-400 hover:to-violet-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-sky-500/20"
            >
              {loading ? (
